...
public class SourceGenerator {
	...
	public static void generQuery(String ClassName) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("config/cn/java/template/DemoQuery.tlf"));
		BufferedWriter bw = new BufferedWriter(new FileWriter("src/cn/java/query/"+ClassName+"Query.java"));
		String line = null;
		String newLine = null;
	...
	public static void generDao(String ClassName) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("config/cn/java/template/DemoDao.tlf"));
		BufferedWriter bw = new BufferedWriter(new FileWriter("src/cn/java/dao/"+ClassName+"Dao.java"));
		String line = null;
		String newLine = null;
		while((line = br.readLine()) != null){
			newLine = line.replace("Demo", ClassName);
	...
	public static void generDaoImpl(String ClassName) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("config/cn/java/template/DemoDaoImpl.tlf"));
		BufferedWriter bw = new BufferedWriter(new FileWriter("src/cn/java/dao/impl/"+ClassName+"DaoImpl.java"));
		String line = null;
		String newLine = null;
		while((line = br.readLine()) != null){
			newLine = line.replace("Demo", ClassName);
	...
	public static void generService(String ClassName) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("config/cn/java/template/DemoService.tlf"));
		BufferedWriter bw = new BufferedWriter(new FileWriter("src/cn/java/service/"+ClassName+"Service.java"));
		String line = null;
		String newLine = null;
		while((line = br.readLine()) != null){
			newLine = line.replace("Demo", ClassName);
	...
	public static void generServiceImpl(String ClassName) throws Exception{
		...
		BufferedReader br = new BufferedReader(new FileReader("config/cn/java/template/DemoServiceImpl.tlf"));
		BufferedWriter bw = new BufferedWriter(new FileWriter("src/cn/java/service/impl/"+ClassName+"ServiceImpl.java"));
		String line = null;
		String newLine = null;
		while((line = br.readLine()) != null){
	...
	public static void generDaoConfig(String ClassName) throws Exception{
		...
		Element newEle = rootElement.addElement("bean")
					...
					.addAttribute("class", "cn.java.dao.impl."+ClassName+"DaoImpl");
	...
	public static void generServiceConfig(String ClassName) throws Exception{
		...
		Element newEle = rootElement.addElement("bean")
					...
					.addAttribute("class", "cn.java.service.impl."+ClassName+"ServiceImpl");
		newEle.addElement("property")
	...
	public static void generAction(String ClassName) throws Exception{
		//获取对象
		String lowerCaseClassName = ClassName.substring(0, 1).toLowerCase() + ClassName.substring(1);
		BufferedReader br = new BufferedReader(new FileReader("config/cn/java/template/DemoAction.tlf"));
		BufferedWriter bw = new BufferedWriter(new FileWriter("src/cn/java/controller/"+ClassName+"Action.java"));
		String line = null;
		String newLine = null;
		while((line = br.readLine()) != null){
			newLine = line.replace("Demo", ClassName).replace("demo", lowerCaseClassName);
	...
	public static void generSpringActionConfig(String ClassName) throws Exception{
		...
		Element newEle = rootElement.addElement("bean")
					...
					.addAttribute("class", "cn.java.controller."+ClassName+"Action")
