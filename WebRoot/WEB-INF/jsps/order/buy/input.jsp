			...
			<div class="square-order">
				<table id="order" width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr id="defaultTr" align="center" bgcolor="#FFFFFF">
						...
						<td><input name="detailPrice" class="prices order_num" style="width:93px;border:1px solid black;text-align:right;padding:2px" type="text" value=""/> 元</td>
						<td class="total" align="right" trTotal="">   </td>
						<td>
					...
					<tr id="finalTr" align="center"
						...
						<td class="all" width="16%" align="right">   </td>
						<td>&nbsp;</td>
					</tr>
				</table>
