...
<script type="text/javascript">
	...
	function loadPro(trObj,productTypeId){
		$.ajax({
			url:"${path}/ajax_productType_getProducts",
			type:"post",
			data:{
	...
	function load_Product_detail(trObj, productId){
		$.ajax({
			url:"${path}/ajax_product_getProductObj",
			type:"post",
			data:{
		...
		<input type="hidden" name="order.orderNum" value="<s:property value="order.orderNum"/>">
			...
			<div class="square-order">
				<table id="order" width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="order.ods" var="detail">
						<tr id="defaultTr" align="center" bgcolor="#FFFFFF">
						<td height="30">
							<!-- <select name="productTypeId" class="goodsType" style="width:200px">
								
							</select> -->
							<s:select list="order.supplier.pts" cssStyle="width:200px" cssClass="goodsType" listKey="productTypeId" listValue="name" name="#detail.product.productType.productTypeId"></s:select>
							<input name="productTypeId" type="hidden" value="<s:property value="#detail.product.productType.productTypeId"/>">
						...
						<td>
							...
							<s:select list="#detail.product.productType.products" cssStyle="width:200px" cssClass="goods" listKey="productId" listValue="name" name="#detail.product.productId"></s:select>
							<input name="productId" type="hidden" value="<s:property value="#detail.product.productId"/>">
						</td>
