...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form id="productForm" action="${path }/ajax_product_update" method="post">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
							...
							<s:select id="productType" style="width:190px" list="product.productType.supplier.pts" name="product.productType.productTypeId" cssClass="kuan" headerKey="" headerValue="----请-选-择----" listKey="productTypeId" listValue="name"></s:select>
