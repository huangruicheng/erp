...
<script type="text/javascript">
	...
	function viewOrderDetail(orderId){
		...
		diag.Title = "查看订单详情";
		diag.URL = "${path}/tranOrderModel_taskDetailBuying?order.orderId="+orderId;
		diag.OKEvent = function(){
			var win = diag.innerFrame.contentWindow;
			//调用提交表单的方法获得返回值
			var result = win.getOrderDetail();
			//如果成功页面要刷新
			if(result == "success"){
				diag.close();
				window.location.href = "${path }/tranOrderModel_tasks?query.orderType=2&query.orderState=1";
			}
		};
		diag.show();
		diag.okButton.value="确定去取货";
	}
	...
	function viewOrderDetail1(orderId){
		...
		diag.OKEvent = function(){
			...
			if(result == "success"){
				diag.close();
				window.location.href = "${path }/tranOrderModel_tasks?query.orderType=2&query.orderState=3";
			}
		};
		diag.show();
...
<div class="content-right">
	...
	<div class="content-text">
		<form action="${path }/tranOrderModel_tasks" method="post"> 
		...
		<input id="orderState" type="hidden" name="query.orderState" value="<s:property value="query.orderState"/>">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<!-- 	<select style="width:137px">
							...
							<s:select list="#{'1':'送货','2':'自提' }" name="query.needs" cssStyle="width:137px" headerKey="" headerValue="----请-选-择----"></s:select>
						</td>
						<td width=""><a id="query"> 
			...
			<div class="square-order">
				<ul>
					<li id="li1"><a href="${path }/tranOrderModel_tasks?query.orderType=2&query.orderState=1" style="text-decoration: none;color: black">待采购</a></li>
					<li id="li2"><a href="${path }/tranOrderModel_tasks?query.orderType=2&query.orderState=3" style="text-decoration: none;color: black">采购中</a></li>
				</ul>
