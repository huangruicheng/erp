...
<script type="text/javascript">
	...
	//修改商品类别信息
	function updateProductTyte(productTypeId){
		var diag = new Dialog();
		diag.Width = 850;
		diag.Height = 200;
		diag.ShowButtonRow=true;
		...
		<form action="${path }/productType_list" method="post">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="60">类别名称:</td>
						<td width="149"><s:textfield name="query.name" type="text" size="18" ></s:textfield></td>
			...
			<div class="square-order">
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="#page.list" var="sp">
						<tr align="center" bgcolor="#FFFFFF">
						<td width="30%" height="30"> <s:property value="#sp.supplier.name"/> </td>
						<td><s:property value="#sp.name"/></td>
						<td>
							<img src="${path}/images/icon_3.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<a href="javascript:void(0)" class="xiu" onclick="updateProductTyte(<s:property value="#sp.productTypeId"/>)">修改</a> 
							</span> 
							<img src="${path}/images/icon_04.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<a href="javascript:void(0)" class="xiu" onclick="deleteProductType(<s:property value="#sp.productTypeId"/>)">删除</a>
							</span>
						</td>
					</tr>
					</s:iterator>
