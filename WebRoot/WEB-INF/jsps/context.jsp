...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="16%"></td>
    <td width="77%"><a href="#"><img src="${path}/images/text_01.gif" border="0" width="115" height="88"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="7%" height="118">&nbsp;</td>
    <td width="16%"></td>
    <td width="77%"><a href="#"><img src="${path}/images/text_02.gif" border="0" width="115" height="88"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" height="18"><a class="cai" href="#">采购申请</a><span style="color:#7d94a9">-></span> <a class="cai" href="#">采购订单</a><span style="color:#7d94a9">-></span> <a class="cai" href="#">收货通知单</a></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="7%" height="118">&nbsp;</td>
    <td width="16%"></td>
    <td width="77%"><a href="#"><img src="${path}/images/text_03.gif" border="0" width="115" height="88"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" height="18"><a class="cai" href="#">采购申请</a><span style="color:#7d94a9">-></span> <a class="cai" href="#">采购订单</a><span style="color:#7d94a9">-></span> <a class="cai" href="#">收货通知单</a></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="7%" height="118">&nbsp;</td>
    <td width="16%"></td>
    <td width="77%"><a href="#"><img src="${path}/images/text_04.gif" border="0" width="115" height="88"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" height="18"><a class="cai" href="#">采购申请</a><span style="color:#7d94a9">-></span> <a class="cai" href="#">采购订单</a><span style="color:#7d94a9">-></span> <a class="cai" href="#">收货通知单</a></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="7%" height="118">&nbsp;</td>
    <td width="16%"></td>
    <td width="77%"><a href="#"><img src="${path}/images/text_05.gif" border="0" width="115" height="88"/></a></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" height="18"><a class="cai" href="#">采购申请</a><span style="color:#7d94a9">-></span> <a class="cai" href="#">采购订单</a><span style="color:#7d94a9">-></span> <a class="cai" href="#">收货通知单</a></td>
