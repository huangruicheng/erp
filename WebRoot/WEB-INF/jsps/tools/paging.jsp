...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="12%">&nbsp;当前 第<span style="color:red;"> <s:property value="#page.pageNo"/></span>/ <s:property value="#page.totalPage"/>页</td>
		<td width="13%">共 <s:property value="#page.totalCount"/>条 记录</td>
	</tr>
</table>
